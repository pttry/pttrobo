...
# haetaan kuvion käyttämä ennustedata 
# kuviossa on sekä bkt että kulutus sarja. Seuraavassa Serie 1 on bkt ja serie 2 kulutus.
ennustedata_path <- "ptt_ennusteet_KT_uusi_sarja_id.xlsx"
ennustedata_serie_name_1 <- kuvio_spec$datas$data_1$datahaku_id
ennustedata_serie_name_2 <- kuvio_spec$datas$data_2$datahaku_id
